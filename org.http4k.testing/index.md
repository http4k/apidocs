...
| [replayingMatchingContent](replaying-matching-content.md) | `fun `[`ReadWriteStream`](../org.http4k.traffic/-read-write-stream/index.md)`.replayingMatchingContent(): `[`HttpHandler`](../org.http4k.core/-http-handler.md) |
