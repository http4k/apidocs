...
| [request](request.md) | `val request: `[`HttpMessageMeta`](../-http-message-meta/index.md)`<`[`Request`](../../org.http4k.core/-request/index.md)`>?` |
...
| [security](security.md) | `val security: `[`Security`](../-security/index.md)`?` |
