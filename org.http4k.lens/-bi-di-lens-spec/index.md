...
| [K8sEnvKey](../../org.http4k.k8s/-k8s-env-key/index.md) | `object K8sEnvKey : `[`BiDiLensSpec`](./index.md)`<`[`K8sEnvironment`](../../org.http4k.k8s/-k8s-environment/index.md)`, `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`>` |
