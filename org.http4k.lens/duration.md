...
`fun BiDiMapping.Companion.duration(): `[`BiDiMapping`](-bi-di-mapping/index.md)`<Duration>` [(source)](https://github.com/http4k/http4k/blob/master/http4k-core/src/main/kotlin/org/http4k/lens/BiDiMapping.kt#L36)
