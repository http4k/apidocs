...
| [removeQuery](remove-query.md) | `abstract fun removeQuery(name: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`): `[`Request`](./index.md) |
...
| Name | Summary |
|---|---|
| [accessTokenRequest](../../org.http4k.security.oauth.server/access-token-request.md) | `fun `[`Request`](./index.md)`.accessTokenRequest(): `[`AccessTokenRequest`](../../org.http4k.security.oauth.server/-access-token-request/index.md) |
