...
| [decimal](../-json/decimal.md) | `abstract fun decimal(value: `[`NODE`](../-json/index.md#NODE)`): `[`BigDecimal`](https://docs.oracle.com/javase/6/docs/api/java/math/BigDecimal.html) |
