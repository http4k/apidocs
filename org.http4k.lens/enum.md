...
`fun <reified T : `[`Enum`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/index.html)`<T>> `[`BiDiLensSpec`](-bi-di-lens-spec/index.md)`<`[`WebForm`](-web-form/index.md)`, `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`>.enum(): `[`BiDiLensSpec`](-bi-di-lens-spec/index.md)`<`[`WebForm`](-web-form/index.md)`, T>`