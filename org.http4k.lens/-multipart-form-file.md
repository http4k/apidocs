[http4k](../index.md) / [org.http4k.lens](index.md) / [MultipartFormFile](./-multipart-form-file.md)

# MultipartFormFile

`object MultipartFormFile : `[`BiDiLensSpec`](-bi-di-lens-spec/index.md)`<`[`MultipartForm`](-multipart-form/index.md)`, `[`FormFile`](../org.http4k.core/-form-file/index.md)`>` [(source)](https://github.com/http4k/http4k/blob/master/http4k-multipart/src/main/kotlin/org/http4k/lens/multipartForm.kt#L19)
