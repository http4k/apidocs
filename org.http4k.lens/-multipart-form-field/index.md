[http4k](../../index.md) / [org.http4k.lens](../index.md) / [MultipartFormField](./index.md)

# MultipartFormField

`data class MultipartFormField` [(source)](https://github.com/http4k/http4k/blob/master/http4k-multipart/src/main/kotlin/org/http4k/lens/parts.kt#L8)
