...
| [RoutingSseHandler](-routing-sse-handler/index.md) | `interface RoutingSseHandler : `[`SseHandler`](../org.http4k.sse/-sse-handler.md) |
...
| [sse](sse.md) | `fun sse(sse: `[`SseConsumer`](../org.http4k.sse/-sse-consumer.md)`): `[`SseHandler`](../org.http4k.sse/-sse-handler.md)<br>`fun sse(vararg list: `[`RoutingSseHandler`](-routing-sse-handler/index.md)`): `[`RoutingSseHandler`](-routing-sse-handler/index.md) |
