...
| [value](value.md) | `fun <BUILD, VALUE : Value<T>, T : `[`Any`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-any/index.html)`> `[`AutoMappingConfiguration`](-auto-mapping-configuration/index.md)`<BUILD>.value(fn: ValueFactory<VALUE, T>): `[`AutoMappingConfiguration`](-auto-mapping-configuration/index.md)`<BUILD>` |
