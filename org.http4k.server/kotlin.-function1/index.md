...
| [toJettyHandler](to-jetty-handler.md) | `fun `[`WsHandler`](../../org.http4k.websocket/-ws-handler.md)`.toJettyHandler(): WebSocketHandler`<br>`fun `[`HttpHandler`](../../org.http4k.core/-http-handler.md)`.toJettyHandler(): ServletContextHandler` |
