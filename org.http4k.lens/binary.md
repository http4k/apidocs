...
`fun WsMessage.Companion.binary(): `[`BiDiWsMessageLensSpec`](-bi-di-ws-message-lens-spec/index.md)`<`[`ByteBuffer`](https://docs.oracle.com/javase/6/docs/api/java/nio/ByteBuffer.html)`>` [(source)](https://github.com/http4k/http4k/blob/master/http4k-core/src/main/kotlin/org/http4k/lens/wsMessageLens.kt#L83)