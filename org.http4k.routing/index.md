...
| Name | Summary |
|---|---|
| [ParameterMatch](-parameter-match/index.md) | `sealed class ParameterMatch : (`[`Request`](../org.http4k.core/-request/index.md)`) -> `[`Boolean`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html) |
...
| [headers](headers.md) | For routes where certain headers are required for correct operation. ParameterMatch is composable.`fun headers(vararg names: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`): `[`ParameterMatch`](-parameter-match/index.md) |
...
| [queries](queries.md) | For routes where certain queries are required for correct operation. ParameterMatch is composable.`fun queries(vararg names: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`): `[`ParameterMatch`](-parameter-match/index.md) |
