...
| [enum](../enum.md) | `fun <T : `[`Enum`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/index.html)`<T>> `[`Path`](./index.md)`.enum(): `[`BiDiPathLensSpec`](../-bi-di-path-lens-spec/index.md)`<T>` |
